...
const COMPETITOR_ROWS = [
  {
    category: 'Coverage',
    rows: [
      { feature: '24/7 Availability', human: '✗', otherAI: '✓', globalVoice: '✓' },
      { feature: 'Zero Hold Time', human: '✗', otherAI: 'Partial', globalVoice: '✓' },
      { feature: 'Simultaneous Calls', human: '1 per person', otherAI: 'Limited', globalVoice: 'Unlimited' },
      { feature: 'Languages Supported', human: '1–2', otherAI: '5–50', globalVoice: '200+' },
    ],
  },
  {
    category: 'Cost & Efficiency',
    rows: [
      { feature: 'Monthly Cost', human: '$3,500–$4,500', otherAI: '$150–$500', globalVoice: '$99–$299' },
      { feature: 'Cost per Call', human: '$5–$8', otherAI: '$0.15–$0.50', globalVoice: '$0.05–$0.12' },
      { feature: 'Setup Time', human: '2–4 weeks', otherAI: '1–2 weeks', globalVoice: 'Hours' },
      { feature: 'Training Required', human: 'Extensive', otherAI: 'Moderate', globalVoice: 'Minimal' },
      { feature: 'Scaling Cost', human: 'Per hire', otherAI: 'Per call', globalVoice: 'Fixed plan' },
    ],
  },
  {
    category: 'Capabilities',
    rows: [
      { feature: 'Call Transcription', human: '✗', otherAI: '✓', globalVoice: '✓ Real-time' },
      { feature: 'Smart Appointment Booking', human: 'Manual', otherAI: 'Basic', globalVoice: '✓' },
      { feature: 'Lead Qualification', human: 'Manual', otherAI: 'Basic', globalVoice: '✓ AI-scored' },
      { feature: 'CRM Integration', human: 'Manual entry', otherAI: 'Some', globalVoice: '✓ Auto-sync' },
      { feature: 'Real-time Analytics', human: '✗', otherAI: 'Basic', globalVoice: '✓ Advanced' },
      { feature: 'Custom Voice Training', human: 'N/A', otherAI: 'Limited', globalVoice: '✓' },
      { feature: 'SMS Integration', human: '✗', otherAI: 'Some', globalVoice: '✓' },
      { feature: 'Sentiment Analysis', human: 'N/A', otherAI: 'Limited', globalVoice: '✓' },
    ],
  },
  {
    category: 'Reliability',
    rows: [
      { feature: 'Uptime Guarantee', human: 'Business hours', otherAI: '99.5%', globalVoice: '99.9%' },
      { feature: 'Call Recording', human: '✗', otherAI: '✓', globalVoice: '✓' },
      { feature: 'Data Encryption', human: 'Varies', otherAI: 'Standard', globalVoice: 'AES-256' },
      { feature: 'Automatic Backup', human: '✗', otherAI: '✓', globalVoice: '✓' },
    ],
  },
]

const COMPETITOR_SCORES = [
  { name: 'GlobalVoice AI', score: 96, gradient: 'from-aurora-cyan to-blue-500' },
...
const FAQS = [
  ...
  { q: 'Can I keep my existing phone number?', a: 'Yes! You can port your existing business number to GlobalVoice AI, or we can provide a new one. The porting process takes less than 24 hours.' },
          ...
          >
            ...
            <div className="bg-gradient-to-r from-aurora-cyan/20 to-blue-600/20 border-b border-white/[0.06] px-4 py-3.5 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-aurora-cyan to-blue-600 flex items-center justify-center text-white text-xs font-bold">
                  G
                </div>
                <div>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-aurora-cyan to-midnight-blue flex items-center justify-center text-white font-bold text-sm">
              G
            </div>
            <span className="font-display text-lg font-bold text-white hidden sm:inline">
              GlobalVoice<span className="text-aurora-cyan"> AI</span>
            </span>
          </Link>
      ...
      <section className="py-20 md:py-28 px-4 bg-deep-space">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              See how GlobalVoice AI compares to a traditional human receptionist and other AI phone tools.
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/[0.06]">
                    ...
                    <th className="text-center py-4 px-5 font-semibold text-aurora-cyan bg-aurora-cyan/[0.03] w-[24%]">GlobalVoice AI</th>
                  </tr>
                </thead>
                <tbody>
                        ...
                        >
                          ...
                          <td className="text-center py-3.5 px-5 bg-aurora-cyan/[0.02]">
                            {row.globalVoice === '✓' ? (
                              ...
                              <span className="text-white font-medium">{row.globalVoice}</span>
                            )}
                          </td>
                        </tr>
                      ))}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of businesses using GlobalVoice AI to handle calls, book appointments, and qualify leads — automatically.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div>
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="font-display text-lg font-bold text-white">GlobalVoice AI</span>
              </Link>
