...
const SCENARIO_RESPONSES: Record<ScenarioId, Record<string, string>> = {
  general: {
    ...
    price: 'Great question! Plans are transparent: Starter at $119/month (500 calls), Growth at $149/month (2,000 calls — most popular), and Enterprise with custom pricing. No hidden fees, no revenue share.',
    pricing: 'Pricing is straightforward: Starter ($119/mo — 500 calls), Growth ($149/mo — 2,000 calls), Enterprise (custom). All plans include a 14-day free trial with no credit card required.',
  ...
  dental: {
    ...
    price: 'A new patient exam with X-rays is typically $150-250 depending on your insurance. We accept most dental insurance plans. We also offer a membership plan for uninsured patients at $349/year.',
