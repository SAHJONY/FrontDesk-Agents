...
const INDUSTRIES = [
  {
    ...
    testimonial: 'FrontDesk Agents AI handles 200+ patient calls daily. Our front desk can finally focus on patient care instead of the phone.',
  ...
  },
  {
    ...
    testimonial: 'Emergency calls get routed instantly to our on-call team. Revenue increased 40% since we deployed FrontDesk Agents AI.',
    author: 'James Wilson',
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-bold hidden sm:inline">FrontDesk Agents AI</span>
          </Link>
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              >
                ...
                <a href="/partners" onClick={() => setMobileMenuOpen(false)} className="text-xl text-gray-300 hover:text-white transition-colors">Partners</a>
                <a href="/industries" onClick={() => setMobileMenuOpen(false)} className="text-xl text-gray-300 hover:text-white transition-colors">Industries</a>
                <a href="/blog" onClick={() => setMobileMenuOpen(false)} className="text-xl text-gray-300 hover:text-white transition-colors">Blog</a>
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto mb-8">
              From neural voice calls to smart scheduling to multi-language support — FrontDesk Agents AI provides a complete,
      ...
      <section id="capabilities" className="py-20 md:py-28 px-4 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            ...
            subtitle="Every feature of the FrontDesk Agents AI receptionist platform — explained in detail."
          />
      ...
      <section className="py-20 md:py-28 px-4 bg-white/[0.02]">
        <div className="max-w-5xl mx-auto">
          <SectionHeading
            ...
            subtitle="See how businesses across industries use FrontDesk Agents AI to transform their phone operations."
          />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { name: 'Dr. Sarah Chen', role: 'Medical Practice Owner', text: 'Patient satisfaction scores jumped 25 points since deploying FrontDesk Agents AI. The AI handles scheduling, refills, and FAQs flawlessly — our staff can finally focus on care.', rating: 5 },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { name: 'Clio', cat: 'Legal' }, { name: 'MyCase', cat: 'Legal' }, { name: 'LawPay', cat: 'Legal' }, { name: 'LexisNexis', cat: 'Legal' },
      ...
      <section id="faq" className="py-20 md:py-28 px-4">
        <div className="max-w-4xl mx-auto">
          <SectionHeading
            ...
            subtitle="Everything you need to know about FrontDesk Agents AI capabilities and implementation."
          />
          <FaqSection />
        </div>
      </section>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of businesses using FrontDesk Agents AI. Start your 14-day free trial — no credit card required.
              </p>
