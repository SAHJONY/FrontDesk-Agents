/**
 * FrontDesk Agents AI - Internationalization (i18n) System
...
export const TRANSLATIONS = {
  en: {
    ...
    footer: {
      ...
      support: 'Support',
      legal: 'Legal',
      copyright: '© 2026 FrontDesk Agents AI. All rights reserved.',
    },
    // Owner Dashboard
    dashboard: {
  ...
  es: {
    ...
    features: {
      title: '¿Por qué FrontDesk Agents AI?',
