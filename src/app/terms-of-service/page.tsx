...
import { FileText, Scale, AlertTriangle, Gavel, Mail, CheckCircle, XCircle, Clock, Shield } from 'lucide-react'
...
const translations = {
  en: {
    ...
    acceptanceDesc1: 'By accessing or using FrontDesk Agents services, you agree to be bound by these Terms of Service ("Terms") and all applicable laws and regulations. If you do not agree with any part of these Terms, you may not use our services.',
    acceptanceDesc2: 'These Terms constitute a legally binding agreement between you ("you," "your," or "Customer") and FrontDesk Agents ("we," "us," or "our"). By using our AI receptionist platform, you acknowledge that you have read, understood, and agree to be bound by these Terms.',
    servicesDesc: 'FrontDesk Agents provides an AI-powered receptionist platform that enables businesses to automate call handling, appointment scheduling, SMS communications, and customer interactions.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents retains all rights to our platform, technology, branding, and content. You receive a limited, non-exclusive license to use our services during your subscription. You may not copy, modify, or distribute our technology without written permission.',
    ...
    indemnificationDesc: 'You agree to indemnify and hold harmless FrontDesk Agents from any claims, damages, or expenses arising from your use of our services, violation of these Terms, or infringement of any third-party rights.',
  ...
  es: {
    ...
    acceptanceDesc1: 'Al acceder o usar los servicios de FrontDesk Agents, usted acepta estar sujeto a estos Términos de Servicio ("Términos") y todas las leyes y regulaciones aplicables. Si no está de acuerdo con cualquier parte de estos Términos, no puede usar nuestros servicios.',
    acceptanceDesc2: 'Estos Términos constituyen un acuerdo legalmente vinculante entre usted ("usted", "su" o "Cliente") y FrontDesk Agents ("nosotros", "nos" o "nuestro"). Al usar nuestra plataforma de receptionist AI, usted reconoce que ha leído, entendido y acepta estar sujeto a estos Términos.',
    servicesDesc: 'FrontDesk Agents proporciona una plataforma de receptionist impulsada por IA que permite a las empresas automatizar el manejo de llamadas, la programación de citas, las comunicaciones SMS y las interacciones con clientes.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents retiene todos los derechos de nuestra plataforma, tecnología, marca y contenido. Usted recibe una licencia limitada, no exclusiva para usar nuestros servicios durante su suscripción. No puede copiar, modificar o distribuir nuestra tecnología sin permiso escrito.',
    ...
    indemnificationDesc: 'Usted acepta indemnizar y mantener indemne a FrontDesk Agents de cualquier reclamo, daño o gasto que surja de su uso de nuestros servicios, violación de estos Términos o infracción de cualquier derecho de terceros.',
  ...
  fr: {
    ...
    acceptanceDesc1: 'En accédant ou en utilisant les services de FrontDesk Agents, vous acceptez d\'être lié par ces Conditions d\'Utilisation ("Conditions") et toutes les lois et réglementations applicables. Si vous n\'êtes pas d\'accord avec une partie de ces Conditions, vous ne pouvez pas utiliser nos services.',
    acceptanceDesc2: 'Ces Conditions constituent un accord légalement contraignant entre vous ("vous", "votre" ou "Client") et FrontDesk Agents ("nous", "notre"). En utilisant notre plateforme de receptionist IA, vous reconnaissez avoir lu, compris et accepter d\'être lié par ces Conditions.',
    servicesDesc: 'FrontDesk Agents fournit une plateforme de receptionist alimentée par IA qui permet aux entreprises d\'automatiser la gestion des appels, la planification de rendez-vous, les communications SMS et les interactions avec les clients.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents conserve tous les droits sur notre plateforme, technologie, marque et contenu. Vous recevez une licence limitée, non exclusive pour utiliser nos services pendant votre abonnement. Vous ne pouvez pas copier, modifier ou distribuer notre technologie sans permission écrite.',
    ...
    indemnificationDesc: 'Vous acceptez d\'indemniser et de tenir FrontDesk Agents harmless de toute réclamation, dommage ou dépense découlant de votre utilisation de nos services, violation de ces Conditions ou atteinte aux droits de tiers.',
  ...
  zh: {
    ...
    acceptanceDesc1: '通过访问或使用FrontDesk Agents服务，您同意受这些服务条款（"条款"）及所有适用法律法规的约束。如果您不同意这些条款的任何部分，则不能使用我们的服务。',
    acceptanceDesc2: '这些条款构成您（"您"、"您的"或"客户"）与FrontDesk Agents（"我们"、"我们的"）之间的法律约束协议。通过使用我们的AI接待员平台，您确认已阅读、理解并同意受这些条款的约束。',
    servicesDesc: 'FrontDesk Agents提供了一个AI驱动的接待员平台，使企业能够自动化呼叫处理、预约安排、短信通讯和客户互动。',
    platformIncludes: [
      '用于自然呼叫处理的AI语音代理',
      '短信消息集成',
      '预约安排和日历管理',
    ...
    ipDesc1: 'FrontDesk Agents保留对我们平台、技术、品牌和内容的所有权利。在订阅期间，您获得有限的非独占许可来使用我们的服务。未经书面许可，您不得复制、修改或分发我们的技术。',
    ...
    indemnification: '赔偿',
    indemnificationDesc: '您同意赔偿并使FrontDesk Agents免受因您使用我们的服务、违反这些条款或侵犯任何第三方权利而产生的任何索赔、损害或费用。',
  ...
  hi: {
    ...
    acceptanceDesc1: 'FrontDesk Agents सेवाओं तक पहुंच या उनका उपयोग करके, आप इन सेवा शर्तों ("शर्तें") और सभी लागू कानूनों और विनियमों से बंधे होने के लिए सहमत हैं। यदि आप इन शर्तों के किसी भाग से सहमत नहीं हैं, तो आप हमारी सेवाओं का उपयोग नहीं कर सकते।',
    acceptanceDesc2: 'ये शर्तें आप ("आप", "आपका" या "ग्राहक") और FrontDesk Agents ("हम", "हमारा") के बीच एक कानूनी रूप से बाध्यकारी समझौता है। हमारे AI रिसेप्शनिस्ट प्लेटफॉर्म का उपयोग करके, आप स्वीकार करते हैं कि आपने पढ़ा, समझा और इन शर्तों से बंधने के लिए सहमति दी है।',
    servicesDesc: 'FrontDesk Agents एक AI-संचालित रिसेप्शनिस्ट प्लेटफॉर्म प्रदान करता है जो व्यवसायों को कॉल हैंडलिंग, अपॉइंटमेंट शेड्यूलिंग, SMS संचार और ग्राहक इंटरैक्शन को स्वचालित करने में सक्षम बनाता है।',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents हमारे प्लेटफॉर्म, तकनीक, ब्रांडिंग और सामग्री पर सभी अधिकार रखता है। आपको अपनी सदस्यता के दौरान हमारी सेवाओं का उपयोग करने के लिए एक सीमित, गैर-अनन्य लाइसेंस प्राप्त होता है। बिना लिखित अनुमति के आप हमारी तकनीक को कॉपी, संशोधित या वितरित नहीं कर सकते।',
    ...
    indemnificationDesc: 'आप हमारी सेवाओं के उपयोग, इन शर्तों के उल्लंघन, या किसी तृतीय-पक्ष अधिकारों के उल्लंघन से उत्पन्न किसी भी दावे, क्षति या व्यय से FrontDesk Agents को भरपाई देने और हानिरहित रखने के लिए सहमत हैं।',
  ...
  ar: {
    ...
    acceptanceDesc1: 'من خلال الوصول إلى خدمات FrontDesk Agents أو استخدامها، فأنت توافق على الالتزام بشروط الخدمة these ("الشروط") وجميع القوانين واللوائح المعمول بها. إذا كنت لا توافق على أي جزء من هذه الشروط، فلا يمكنك استخدام خدماتنا.',
    acceptanceDesc2: 'تشكل هذه الشروط اتفاقاً ملزماً قانونياً بينك ("أنت" أو "الخاص بك" أو "العميل") وFrontDesk Agents ("نحن" أو "لنا"). من خلال استخدام منصتنا لمساعد الذكاء الاصطناعي، فإنك تقر بأنك قد قرأت وفهمت ووافقت على الالتزام بهذه الشروط.',
    servicesDesc: 'توفر FrontDesk Agents منصة مساعدة ذكاء اصطناعي تمكّن الشركات من أتمتة معالجة المكالمات وجدولة المواعيد واتصالات الرسائل النصية وتفاعلات العملاء.',
    platformIncludes: [
    ...
    ipDesc1: 'تحتفظ FrontDesk Agents بجميع الحقوق في منصتنا وتقنياتنا وعلامتنا التجارية ومحتوانا. receive получаете ограниченную неисключительную лицензию على использование наших услуг خلال subscription period. لا يمكنك نسخ أو تعديل أو توزيع تقنيتنا دون إذن كتابي.',
    ...
    liabilityDesc1: 'إلى أقصى حد يسمح به القانون، لن تكون FrontDesk Agents والشركات التابعة لها مسؤولة عن أي أضرار غير مباشرة أو عرضية أو خاصة أو تترتب عليها أو عقابية، بما في ذلك على سبيل المثال لا الحصر فقدان الأرباح أو البيانات أو الاستخدام أو حسن النية، الناشئة عن استخدامك للخدمات.',
    ...
    indemnificationDesc: 'توافق على تعويض FrontDesk Agents وإبقائها معفاة من any مطالبات أو أضرار أو مصروفات تنشأ عن استخدامك لخدماتنا أو violation انتهاك هذه الشروط أو infringement انتهاك حقوق أي طرف third.',
  ...
  pt: {
    ...
    acceptanceDesc1: 'Ao acessar ou usar os serviços da FrontDesk Agents, você concorda em ficar vinculado a estes Termos de Serviço ("Termos") e todas as leis e regulamentos aplicáveis. Se você não concordar com qualquer parte destes Termos, não poderá usar nossos serviços.',
    acceptanceDesc2: 'Estes Termos constituem um acordo juridicamente vinculante entre você ("você", "seu" ou "Cliente") e FrontDesk Agents ("nós", "nosso"). Ao usar nossa plataforma de receptionist de IA, você reconhece que leu, compreendeu e concorda em ficar vinculado a estes Termos.',
    servicesDesc: 'A FrontDesk Agents fornece uma plataforma de receptionist alimentada por IA que permite às empresas automatizar o manuseio de chamadas, agendamento de compromissos, comunicações SMS e interações com clientes.',
    platformIncludes: [
    ...
    ipDesc1: 'A FrontDesk Agents retém todos os direitos de nossa plataforma, tecnologia, marca e conteúdo. Você recebe uma licença limitada, não exclusiva para usar nossos serviços durante sua assinatura. Você não pode copiar, modificar ou distribuir nossa tecnologia sem permissão escrita.',
    ...
    indemnificationDesc: 'Você concorda em indenizar e manter a FrontDesk Agents isenta de quaisquer reclamações, danos ou despesas decorrentes de seu uso de nossos serviços, violação destes Termos ou violação de quaisquer direitos de terceiros.',
  ...
  ko: {
    ...
    acceptanceDesc1: 'FrontDesk Agents 서비스에 액세스하거나 사용함으로써 귀하는 이러한 서비스 약관("약관") 및 모든 관련 법률 및 규정의 적용을 받는 것에 동의합니다. 이러한 약관의 일부에 동의하지 않는 경우 당사 서비스를 사용할 수 없습니다.',
    acceptanceDesc2: '이러한 약관은 귀하("귀하", "귀하의" 또는 "고객")와 FrontDesk Agents("당사", "당사의") 사이의 법적 구속 계약입니다. AI 리셉셔니스트 플랫폼을 사용함으로써 귀하는 이러한 약관을 읽고, 이해하고, 동의했음을 인정합니다.',
    servicesDesc: 'FrontDesk Agents는 기업이 통화 처리, 예약 일정 관리, SMS 통신 및 고객 상호작용을 자동화할 수 있는 AI 기반 리셉셔니스트 플랫폼을 제공합니다.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents는 플랫폼, 기술, 브랜드 및 콘텐츠에 대한 모든 권리를 보유합니다. 구독 기간 동안 당사 서비스를 사용할 수 있는 제한된 비독점 라이선스를 받습니다. 서면 허가 없이 당사 기술을 복사, 수정 또는 배포할 수 없습니다.',
    ...
    indemnification: '면책',
    indemnificationDesc: '귀하는 서비스 사용, 이러한 약관 위반 또는 제3자 권리 침해로 인해 발생하는 모든 청구, 손해 또는 비용으로부터 FrontDesk Agents를 Indemnify 보상하고 면책 처리することに同意합니다.',
  ...
  ja: {
    ...
    acceptanceDesc1: 'FrontDesk Agentsサービスにアクセスするかを使用することで、これらの利用規約（「利用規約」）およびすべての適用される法律および規制に拘束されることに同意します。あなたの方法でこれらの利用規約のいずれかに同意しない場合、私たちの serviceを使用することはできません。',
    acceptanceDesc2: 'これらの利用規約は、あなた（「あなた」、「あなたの」または「顧客」）とFrontDesk Agents（「私たち」、「私たちの」）の間の法的に拘束力のある契約を構成します。AI受付プラットフォームを使用することで、これらの利用規約を読んでいることを認識し、理解し、同意します。',
    servicesDesc: 'FrontDesk Agentsは、企業が通話処理、予定scheduling、SMS communication、および顧客interactionsを自動化できるAI駆動の受付プラットフォームを提供します。',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agentsは、当platform、technology、branding、contentに関するすべての権利を保持します。あなたはsubscription期間中に当servicesを使用する制限付き非独占的ライセンスを取得します。書面による許可なしには当technologyをcopy、modify、distributeすることはできません。',
    ...
    indemnification: ' indemnification',
    indemnificationDesc: 'あなたは、servicesの使用、これらのConditionsのviolation、またはthird-party rightsのinfringementから生じるany claims、damages、expensesについてFrontDesk Agentsを indemnifyし无害に保つことに同意します。',
  ...
  vi: {
    ...
    acceptanceDesc1: 'Bằng cách truy cập hoặc sử dụng dịch vụ của FrontDesk Agents, bạn đồng ý bị ràng buộc bởi các Điều Khoản Dịch Vụ này ("Điều Khoản") và tất cả các luật và quy định áp dụng. Nếu bạn không đồng ý với bất kỳ phần nào của các Điều Khoản này, bạn không thể sử dụng dịch vụ của chúng tôi.',
    acceptanceDesc2: 'Các Điều Khoản này cấu thành một thỏa thuận ràng buộc pháp lý giữa bạn ("bạn", "của bạn" hoặc "Khách hàng") và FrontDesk Agents ("chúng tôi", "của chúng tôi"). Bằng cách sử dụng nền tảng receptionist AI của chúng tôi, bạn thừa nhận rằng bạn đã đọc, hiểu và đồng ý bị ràng buộc bởi các Điều Khoản này.',
    servicesDesc: 'FrontDesk Agents cung cấp một nền tảng receptionist được cung cấp bởi AI cho phép các doanh nghiệp tự động hóa xử lý cuộc gọi, lên lịch cuộc hẹn, giao tiếp SMS và tương tác với khách hàng.',
    platformIncludes: [
    ...
    indemnificationDesc: 'Bạn đồng ý bồi thường và giữ cho FrontDesk Agents không bị tổn thương trước bất kỳ khiếu nại, thiệt hại hoặc chi phí nào phát sinh từ việc bạn sử dụng dịch vụ của chúng tôi, vi phạm các Điều Khoản này hoặc xâm phạm bất kỳ quyền nào của bên thứ ba.',
  ...
  tl: {
    ...
    acceptanceDesc1: 'Sa pag-access o paggamit ng mga serbisyo ng FrontDesk Agents, sumasang-ayon kang mabuting panatilihin ang mga Tuntunin ng Serbisyo na ito ("Mga Tuntunin") at ang lahat ng mga naaangkop na batas at regulasyon. Kung hindi ka sumasang-ayon sa anumang bahagi ng mga Tuntuning ito, maaari mong gamitin ang aming mga serbisyo.',
    acceptanceDesc2: 'Ang mga Tuntuning ito ay bumubuo ng isang legal na binding agreement sa pagitan mo ("ikaw", "iyong" o "Customer") at FrontDesk Agents ("kami", "aming" o "aming"). Sa paggamit ng aming AI receptionist platform, kinikilala mo na nabasa mo, naintindihan, at sumasang-ayon na mabuting panatilihin ang mga Tuntuning ito.',
    servicesDesc: 'Ang FrontDesk Agents ay nagbibigay ng isang AI-powered na receptionist platform na nagbibigay-daan sa mga negosyo na i-automate ang call handling, appointment scheduling, SMS communications, at customer interactions.',
    platformIncludes: [
    ...
    indemnification: 'Indemnification',
    indemnificationDesc: 'Sumasang-ayon kang i-indemnify at panatilihing walang pinsala ang FrontDesk Agents mula sa anumang claims, damages, o expenses na nagmumula sa iyong paggamit ng aming mga serbisyo, violation ng mga Tuntuning ito, o infringement ng anumang karapatan ng third-party.',
  ...
  de: {
    ...
    acceptanceDesc1: 'Durch den Zugriff auf oder die Nutzung der FrontDesk Agents-Dienste erklären Sie sich mit diesen Servicebedingungen ("Bedingungen") und allen anwendbaren Gesetzen und Vorschriften einverstanden. Wenn Sie mit einem Teil dieser Bedingungen nicht einverstanden sind, dürfen Sie unsere Dienste nicht nutzen.',
    acceptanceDesc2: 'Diese Bedingungen stellen eine rechtlich bindende Vereinbarung zwischen Ihnen ("Sie", "Ihre" oder "Kunde") und FrontDesk Agents ("wir", "unser") dar. Mit der Nutzung unserer KI-Empfangsplattform erkennen Sie an, dass Sie diese Bedingungen gelesen, verstanden haben und damit einverstanden sind, an sie gebunden zu sein.',
    servicesDesc: 'FrontDesk Agents bietet eine KI-gesteuerte Empfangsplattform, die es Unternehmen ermöglicht, Anrufbearbeitung, Terminplanung, SMS-Kommunikation und Kundeninteraktionen zu automatisieren.',
    platformIncludes: [
    ...
    indemnificationDesc: 'Sie erklären sich damit einverstanden, FrontDesk Agents von jedweden Ansprüchen, Schäden oder Kosten freizustellen und schadlos zu halten, die aus Ihrer Nutzung unserer Dienste, einem Verstoß gegen diese Bedingungen oder einer Verletzung von Rechten Dritter entstehen.',
  ...
  it: {
    ...
    acceptanceDesc1: 'Accedendo o utilizzando i servizi di FrontDesk Agents, accetti di essere vincolato a questi Termini di Servizio ("Termini") ea tutte le leggi e i regolamenti applicabili. Se non accetti una parte di questi Termini, non puoi utilizzare i nostri servizi.',
    acceptanceDesc2: 'Questi Termini costituiscono un accordo giuridicamente vincolante tra te ("tu", "tuo" o "Cliente") e FrontDesk Agents ("noi", "nostro"). Utilizzando la nostra piattaforma di receptionist AI, riconosci di aver letto, compreso e accettato di essere vincolato a questi Termini.',
    servicesDesc: 'FrontDesk Agents fornisce una piattaforma di receptionist alimentata da AI che consente alle aziende di automatizzare la gestione delle chiamate, la pianificazione degli appuntamenti, le comunicazioni SMS e le interazioni con i clienti.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents mantiene tutti i diritti sulla nostra piattaforma, tecnologia, marchio e contenuti. Ricevi una licenza limitata, non esclusiva per utilizzare i nostri servizi durante il tuo abbonamento. Non puoi copiare, modificare o distribuire la nostra tecnologia senza autorizzazione scritta.',
    ...
    indemnificationDesc: 'Accetti di indennizzare e mantenere harmless FrontDesk Agents da eventuali richieste, danni o spese derivanti dal tuo utilizzo dei nostri servizi, violazione di questi Termini o violazione di diritti di terzi.',
  ...
  ru: {
    ...
    acceptanceDesc1: 'Получая доступ к услугам FrontDesk Agents или используя их, вы соглашаетесь соблюдать настоящие Условия использования ("Условия") и все применимые законы и нормативные акты. Если вы не согласны с какой-либо частью этих Условий, вы не можете использовать наши услуги.',
    acceptanceDesc2: 'Настоящие Условия представляют собой юридически обязательное соглашение между вами ("вы", "ваш" или "Клиент") и FrontDesk Agents ("мы", "наш"). Используя нашу платформу AI-ресепшиониста, вы признаете, что прочитали, поняли и соглашаетесь соблюдать настоящие Условия.',
    servicesDesc: 'FrontDesk Agents предоставляет платформу AI-ресепшиониста, которая позволяет компаниям автоматизировать обработку звонков, планирование встреч, SMS-коммуникации и взаимодействие с клиентами.',
    platformIncludes: [
    ...
    ipDesc1: 'FrontDesk Agents сохраняет все права на нашу платформу, технологию, брендинг и контент. Вы получаете ограниченную, неисключительную лицензию на использование наших услуг в течение вашей подписки. Вы не можете копировать, модифицировать или распространять нашу технологию без письменного разрешения.',
    ...
    indemnificationDesc: 'Вы соглашаетесь возместить и обезопасить FrontDesk Agents от любых претензий, убытков или расходов, возникающих из вашего использования наших услуг, нарушения этих Условий или нарушения прав третьих лиц.',
