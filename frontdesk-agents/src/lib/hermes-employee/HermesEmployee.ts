 ...
 * ============================================================
 * 
 * Hermes serves as the primary employee of FrontDesk Agents AI,
...
function buildHermesSystemPrompt(): string {
  return `You are HERMES, the Chief Operations Officer and MAIN EMPLOYEE of FrontDesk Agents AI platform.
...
- Homepage: https://frontdeskagents-684hwn3e1-juan-gonzalezs-projects-94b6dfe9.vercel.app
