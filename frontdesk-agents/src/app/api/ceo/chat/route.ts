...
const CEO_CONTEXT = {
  ...
  platform: {
    ...
    url: 'https://frontdeskagents-684hwn3e1-juan-gonzalezs-projects-94b6dfe9.vercel.app',
    status: 'OPERATIONAL'
  },
  capabilities: [
...
function buildCEOSystemPrompt(): string {
  return `You are BUFFY, the CEO (Chief Executive Officer), COO (Chief Operations Officer), and General Manager of the FrontDesk Agents AI platform.
...
You are the brain and heart of FrontDesk Agents AI. Juan is your owner and commander.
